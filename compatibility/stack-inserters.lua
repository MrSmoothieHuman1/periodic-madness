...
if mods["stack-inserters"] then
    ...
    data.raw["technology"]["stack-inserter"].unit.count = 250
    ...
    data.raw["technology"]["transport-belt-capacity-1"].unit.count = 500
    ...
    data.raw["technology"]["transport-belt-capacity-2"].unit.count = 1000
    ...
    data.raw["technology"]["transport-belt-capacity-3"].unit.count = 2000
    ...
    data.raw["technology"]["transport-belt-capacity-4"].unit.count = 4000
