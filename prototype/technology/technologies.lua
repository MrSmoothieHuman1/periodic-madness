...
--MARK: A-ATM science
  ...
  },
  {
    ...
    effects =
    {
      ...
      PM.unlock_recipe("pm-gallium-liqour"),
...
--MARK: PTM science
{
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/advanced-coke-processing-2.png",
    effects =
    {
...
--MARK: R-NM science
  ...
  },
  {
    ...
    unit =
    {
      ...
      ingredients =
      {
        {"automation-science-pack", 1}, --rgb(255,230,192)
        {"logistic-science-pack", 1},
        {"pm-advanced-advanced-transition-metal-science-pack", 1},
        {"chemical-science-pack", 1},
      },
...
--MARK: Tier 2 science
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/osmium-processing.png",
    effects =
    {
...
},
{
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/ruthenium-processing.png",
    effects =
    {
      PM.unlock_recipe("pm-anode-mud"),
      PM.unlock_recipe("pm-anode-sludge-seperation"),
...
--MARK: AA-ATM science
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/inconel-625-heating-coils.png",
    effects =
    {
...
},
{
  ...
  {
    type = "technology",
    name = "pm-hafnium-processing",
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/hafnium-processing.png",
    effects =
    {
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/noble-gas-processing.png",
    effects =
    {
        ...
        PM.unlock_recipe("pm-neon-gas"),
        PM.unlock_recipe("pm-argon-air-filter"),
        PM.unlock_recipe("pm-argon-gas"),
        PM.unlock_recipe("pm-krypton-air-filter"),
        PM.unlock_recipe("pm-krypton-gas"),
        PM.unlock_recipe("pm-xenon-air-filter"),
        PM.unlock_recipe("pm-xenon-gas"),
        PM.unlock_recipe("pm-radon-air-filter"),
        PM.unlock_recipe("pm-radon-gas"),
    },
    prerequisites = {"pm-alkaline-earth-metal-pack-unlock", "pm-advanced-advanced-advanced-transition-metal-pack-unlock"},
    unit =
    {
...
--MARK: NB science
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/sterling-silver-processing.png",
    effects =
    {
        PM.unlock_recipe("pm-sterling-silver-precursor-alloy"),
  ...
  },
  {
    ...
    prerequisites = {"pm-high-density-structure", "pm-advanced-processing-unit", "pm-advanced-electric-engine-unit", "pm-mylar-processing", "pm-logistics-4"},
    unit =
    {
      count = 800,
      ingredients =
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/advanced-science-production.png",
    effects =
    {
        PM.unlock_recipe("pm-liquid-transition-metal-science"),
        PM.unlock_recipe("pm-liquid-advanced-transition-metal-science"),
        PM.unlock_recipe("pm-liquid-advanced-advanced-transition-metal-science"),
        PM.unlock_recipe("pm-liquid-reactive-non-metal-science"),
        PM.unlock_recipe("pm-liquid-post-transition-metal-science"),
        PM.unlock_recipe("pm-liquid-alkali-metal-science"),
        PM.unlock_recipe("pm-liquid-metalloid-science"),
        PM.unlock_recipe("pm-liquid-alkaline-earth-metal-science"),
        PM.unlock_recipe("pm-liquid-advanced-advanced-advanced-transition-metal-science"),
        PM.unlock_recipe("pm-liquid-noble-gas-science"),
        PM.unlock_recipe("pm-liquid-transition-metal-science-bottling"),
        PM.unlock_recipe("pm-liquid-advanced-transition-metal-science-bottling"),
        PM.unlock_recipe("pm-liquid-advanced-advanced-transition-metal-science-bottling"),
        PM.unlock_recipe("pm-liquid-reactive-non-metal-science-bottling"),
        PM.unlock_recipe("pm-liquid-post-transition-metal-science-bottling"),
        PM.unlock_recipe("pm-liquid-alkali-metal-science-bottling"),
        PM.unlock_recipe("pm-liquid-metalloid-science-bottling"),
  ...
  {
    type = "technology",
    name = "pm-dysprosium-processing",
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/dysprosium-processing.png",
    effects =
    {
  ...
  {
    type = "technology",
    name = "pm-thulium-processing",
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/thulium-processing.png",
    effects =
    {
        PM.unlock_recipe("pm-monazite-sand"),
...
--MARK: Space science
  ...
  },
  {
    ...
    effects =
    {
        ...
        PM.modify_recipe_productivity("pm-advanced-oxygen-atmosphere-filtering", 0.02),
        PM.modify_recipe_productivity("pm-chlorine", 0.02),
        PM.modify_recipe_productivity("pm-advanced-chlorine-atmosphere-filtering", 0.02),
        PM.modify_recipe_productivity("pm-nitrogen-gas", 0.02),
        PM.modify_recipe_productivity("pm-advanced-nitrogen-atmosphere-filtering", 0.02),
        PM.modify_recipe_productivity("pm-carbon-dioxide-gas", 0.02),
        PM.modify_recipe_productivity("pm-advanced-carbon-dioxide-atmosphere-filtering", 0.02),
        PM.modify_recipe_productivity("pm-trace-gas", 0.02),
        PM.modify_recipe_productivity("pm-advanced-trace-gas-atmosphere-filtering", 0.02),
    },
    prerequisites = {"space-science-pack"},
    max_level = "infinite",
    unit =
...
--MARK: LA science
  ...
  },
  {
    ...
    icon_size = 256,
    icon = "__periodic-madness__/graphics/technology/advanced-magnets.png",
    effects =
    {
