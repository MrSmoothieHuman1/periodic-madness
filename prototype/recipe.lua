data:extend({
...

  {
    ...
    crafting_machine_tint =
    {
        ...
        secondary = tints.electronic_breadboard,
...

  {
    ...
    crafting_machine_tint = 
    {
        ...
        secondary = tints.fluid_resistant_breadboard,
        tertiary = tints.empty,
        quaternary = tints.empty
    },
    energy_required = 3,
  ...
  },
  {
    ...
    crafting_machine_tint = 
    {
        ...
        secondary = tints.advanced_breadboard,
        tertiary = tints.empty,
        quaternary = tints.empty
    },
    energy_required = 6,
...

  {
    ...
    crafting_machine_tint = 
    {
        ...
        secondary = tints.processing_breadboard,
        tertiary = tints.ferric_chloride,
  ...
  },
  {
    ...
    ingredients =
    {
      ...
      PM.ingredient("pm-nitric-acid", 6, "fluid")
    },
    results =
    {
...

  {
    ...
    results =
    {
      PM.product("pm-palladium-catalyst"):amount(1):chance(0.1, 1):catalyst(1):done(),
      PM.product("pm-catalyst-container"):amount(1):chance(0, 0.1):catalyst(1):done(),
  ...
  },
  {
    ...
    results =
    {
      ...
      PM.product("pm-vanadium-oxide-catalyst"):amount(5):chance(0.2, 1):done(),
  ...
  },
  {
    ...
    results =
    {
      PM.product("pm-palladium-catalyst"):amount(1):chance(0.15, 1):catalyst(1):done(),
  ...
  },
  {
    ...
    results =
    {
      ...
      PM.product("water", "fluid"):amount(10):done(),
      PM.product("pm-copper-zinc-aluminium-catalyst"):amount(1):chance(0.05, 1):catalyst(1):done(),
  ...
  },
  {
    ...
    results =
    {
      ...
      PM.product("pm-vanadium-oxide-catalyst"):amount(1):chance(0.15, 1):catalyst(1):done(),
      PM.product("pm-catalyst-container"):amount(1):chance(0, 0.15):catalyst(1):done()
    }
  },
  {
  ...
  },
  {
    ...
    crafting_machine_tint =
    {
        primary = tints.electronic_breadboard, --north breadboard
        secondary = tints.electronic_breadboard, --south breadboard
        tertiary = tints.empty, --left pipe/container
  ...
  },
  {
    ...
    crafting_machine_tint =
    {
        primary = tints.fluid_resistant_breadboard, --north breadboard
        secondary = tints.fluid_resistant_breadboard, --south breadboard
        tertiary = tints.empty, --left pipe/container
        quaternary = tints.empty --right pipe/container
    },
    energy_required = 1.5,
  ...
  },
  {
    ...
    crafting_machine_tint =
    {
        primary = tints.advanced_breadboard, --north breadboard
        secondary = tints.advanced_breadboard, --south breadboard
        tertiary = tints.empty, --left pipe/container
        quaternary = tints.empty --right pipe/container
    },
    energy_required = 3,
  ...
  },
  {
    ...
    crafting_machine_tint =
    {
        primary = tints.processing_breadboard, --north breadboard
        secondary = tints.processing_breadboard, --south breadboard
  ...
  },
  {
    ...
    results = 
    {
      ...
      PM.product("pm-cobalt-catalyst"):amount(3):chance(0.2, 1):catalyst(3):done(),
  ...
  },
  {
    ...
    results =
    {
      ...
      PM.product("pm-vanadium-oxide-catalyst"):amount(1):chance(0.1, 1):done(),
  ...
  },
  {
    ...
    results =
    {
      ...
      PM.product("pm-cobalt-catalyst"):amount(2):chance(0.2, 1):catalyst(2):done(),
  ...
  },
  {
    ...
    results =
    {
      PM.product("pm-vanadium-oxide-catalyst"):amount(2):chance(0.25, 1):catalyst(2):done(),
  ...
  },
  {
    ...
    crafting_machine_tint =
    {
        primary = tints.advanced_processing_breadboard, --south breadboard
        secondary = tints.advanced_processing_breadboard, --north breadboard
  ...
  },
  {
    ...
    results =
    {
        ...
        PM.product("pm-yttrium-catalyst"):amount(2):chance(0.1, 1):catalyst(2):done(),
  ...
  },
  {
    ...
    results = 
    {
        ...
        PM.product("pm-yttrium-catalyst"):amount(2):chance(0.25, 1):catalyst(2):done(),
        PM.product("pm-catalyst-container"):amount(2):chance(0, 0.25):catalyst(2):done()
    }
  },
  {
