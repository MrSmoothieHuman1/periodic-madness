...
data.raw["item"]["uranium-fuel"].subgroup = "pm-uranium-ac"
data.raw["item"]["uranium-fuel"].order = "e"
data.raw["recipe"]["uranium-processing"].subgroup = "pm-uranium-ac"
data.raw["recipe"]["uranium-processing"].order = "a"
data.raw["recipe"]["kovarex-enrichment"].subgroup = "pm-uranium-ac"
data.raw["recipe"]["kovarex-enrichment"].order = "b"
