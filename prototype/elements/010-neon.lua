data:extend({
...

  {
    ...
    results = 
    {
        PM.product("pm-neon-air-filter"):amount(2):done()
    }
  },
  {
    type = "recipe",
    ...
    results = 
    {
        PM.product("pm-neon-gas", "fluid"):amount(15):done(),
        PM.product("pm-trace-gas", "fluid"):amount(15):chance(0.5):done(),
        PM.product("pm-neon-air-filter"):amount(1):chance(0.5):catalyst(1):done()
    }
  },
{
    type = "recipe",
    ...
    results = 
    {
        ...
        PM.product("pm-palladium-catalyst"):amount(2):chance(0.25, 1):done(),
        PM.product("pm-catalyst-container"):amount(2):chance(0, 0.25):done()
    }
},
{
  type = "recipe",
  name = "pm-neon-gas-atmospheric-voiding",
  icon_size = 64,
  icons = 
    {
      {
