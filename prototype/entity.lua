...
local asm2_pipe_pictures = require("__base__.prototypes.entity.assembler-pictures").assembler2pipepictures
...
data:extend({
    ...
    status_colors = pm_diode_status_colors(),
        animation =
        {
          layers =
          {
            ...
            {
              filename = "__periodic-madness__/graphics/entities/buildings/crusher-1/crusher-1-crushers.png",
              width = 192,
              height = 205,
              frame_count = 48,
              line_length = 8,
            ...
            {
              filename = "__periodic-madness__/graphics/entities/buildings/crusher-1/crusher-gears.png",
              width = 192,
              height = 205,
              frame_count = 48,
              line_length = 8,
            ...
            {
              filename = "__periodic-madness__/graphics/entities/buildings/crusher-1/crusher-top-gears.png",
              width = 192,
              height = 205,
              frame_count = 48,
              line_length = 8,
            ...
            {
              filename = "__periodic-madness__/graphics/entities/buildings/crusher-1/crusher-shadow.png",
              width = 192,
              height = 205,
              frame_count = 1,
              line_length = 1,
        ...
        {
            {
                ...
                animation =
                {
                    ...
                    {
                        {
                            filename = "__periodic-madness__/graphics/entities/buildings/crusher-1/crusher-light.png",
                            width = 192,
                            height = 205,
                            frame_count = 1,
                            line_length = 1,
...

  {
    ...
    status_colors = pm_diode_status_colors(),
        animation =
        {
          ...
          {
            {
              filename = "__periodic-madness__/graphics/entities/buildings/crusher-2/crusher-2-base.png",
              width = 192,
              height = 205,
              frame_count = 1,
              line_length = 1,
            ...
            {
              filename = "__periodic-madness__/graphics/entities/buildings/crusher-2/crusher-2-side-gears.png",
              width = 192,
              height = 205,
              frame_count = 48,
              line_length = 8,
    ...
    {
      {
        ...
        pipe_connections =
        {
          { flow_direction = "input-output", direction = defines.direction.east, position = { 2, 0 }}, --correct
          { flow_direction = "input-output", direction = defines.direction.west, position = { -2, 0 }} --correct
        },
      },
      {
        production_type = "output",
      ...
      },
      {
        ...
        pipe_connections =
        {
          { flow_direction = "input", direction = defines.direction.west, position = { -2, 1 }} --correct
        },
      },
      {
        production_type = "input",
      ...
      },
      {
        ...
        pipe_connections = 
        {
          { flow_direction = "output", direction = defines.direction.east, position = { 2, 1 }} --correct
        },
      },
      {
        production_type = "output",
  ...
  }--[[@as data.AssemblingMachinePrototype]],
  {
    ...
    {
      {inventory_index = defines.inventory.crafter_modules, shift = {0, 1.1}, multi_row_initial_height_modifier = -0.3, max_icons_per_row = 4, scale = 0.42}
    },
    allowed_effects = PM.all_effects(),
	...
	}--[[@as data.ReactorPrototype]],
  {
    ...
    fluid_box =
    {
      ...
      pipe_connections = 
      {
        {flow_direction="input-output", direction = defines.direction.north, position = {-1.5, -1.5}},
        {flow_direction="input-output", direction = defines.direction.north, position = {1.5, -1.5}},

        {flow_direction="input-output", direction = defines.direction.south, position = {-1.5, 1.5}},
        {flow_direction="input-output", direction = defines.direction.south, position = {1.5, 1.5}},

        {flow_direction="input-output", direction = defines.direction.east, position = {1.5, 1.5}},
        {flow_direction="input-output", direction = defines.direction.west, position = {-1.5, -1.5}},
      },
      secondary_draw_orders = { north = -1 }
    }
},
  ...
  animation =
  {
    north =
    {
        layers =
        {
          {
            filename =
            "__periodic-madness__/graphics/entities/buildings/mixing-tank-1/mixing-tank-north-south-base.png",
            width = 320,
            height = 320,
            repeat_count = 32,
            line_length = 1,
    ...
    east =
    {
        layers =
        {
          {
            filename =
            "__periodic-madness__/graphics/entities/buildings/mixing-tank-1/mixing-tank-east-west-base.png",
            width = 320,
            height = 320,
            repeat_count = 32,
            line_length = 1,
...
}--[[@as data.AssemblingMachinePrototype]],
{
  ...
  },
  {
    ...
    input_fluid_box =
    {
      ...
      pipe_connections =
      {
        {flow_direction="input-output", direction = defines.direction.north --[[@as int]], position = {1.5, -2.5}}, --right input
        {flow_direction="input-output", direction = defines.direction.north --[[@as int]], position = {-1.5, -2.5}}, --left input

        {flow_direction="input-output", direction = defines.direction.east --[[@as int]], position = {2.5, 2.5}}, --east bottom
        {flow_direction="input-output", direction = defines.direction.west --[[@as int]], position = {-2.5, -2.5}} --west top
      },
    },
    output_fluid_box = 
    {
      ...
      pipe_connections =
      {
        {flow_direction="input-output", direction = defines.direction.south --[[@as int]], position = {-1.5, 2.5}}, --right input
        {flow_direction="input-output", direction = defines.direction.south --[[@as int]], position = {1.5, 2.5}}, --left input

        {flow_direction="input-output", direction = defines.direction.west --[[@as int]], position = {-2.5, 2.5}}, --west bottom
...
fluid_boxes =
{
...
}--[[@as data.AssemblingMachinePrototype]],
  {
    ...
    icon_size = 64,
    flags = { "placeable-neutral", "placeable-player", "player-creation" },
    minable = { mining_time = 0.33, result = "pm-alpha-inator" },
    max_health = 800,
    corpse = "pm-electronic-laser-etcher",
    dying_explosion = "assembling-machine-1-explosion",
    resistances =
  ...
  }--[[@as data.AssemblingMachinePrototype]],
  {
    ...
    icon_size = 64,
    flags = { "placeable-neutral", "placeable-player", "player-creation" },
    minable = { mining_time = 0.33, result = "pm-beta-inator" },
    max_health = 800,
    corpse = "pm-electronic-laser-etcher",
    dying_explosion = "assembling-machine-1-explosion",
    resistances =
    ...
    animation =
    {
      ...
      {
        {
          filename = "__periodic-madness__/graphics/entities/buildings/beta-inator/beta-inator.png",
          width = 256,
          height = 256,
          animation_speed = 0.4,
          scale = 0.5
...
fluid_boxes =
{
...
}--[[@as data.AssemblingMachinePrototype]],
  {
    ...
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 0.2, result = "substation"},
