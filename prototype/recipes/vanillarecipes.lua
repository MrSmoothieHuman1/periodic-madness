...
data.raw["recipe"]["inserter"].ingredients =
{
  ...
  PM.ingredient("iron-gear-wheel", 1),
...
data.raw["recipe"]["rocket-silo"].ingredients =
{
    ...
    PM.ingredient("pm-heavyweight-framing", 200),
