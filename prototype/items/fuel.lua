...
data:extend({
  ...
  },
  {
    ...
    fuel_value = "12MJ",
    fuel_categories = {"pm-vehicle-fuel-canisters"},
  ...
  },
  {
    ...
    subgroup = "pm-fuel-rods",
    order = "c",
    fuel_categories = {"pm-strontium-fuel-rods"},
    burnt_result = "pm-spent-fuel-rod",
    fuel_value = "25MJ",
    stack_size = 10
  },
...
{
    PM.product("rocket-fuel"):amount(1):done(),
    PM.product("pm-empty-glass-ampule"):amount(4):catalyst(4):chance(0.95):done()
}
