...
data:extend({
    ...
    },
    {
      ...
      },
      {
        ...
        localised_description = {"item-description.speed-module"},
        icon = "__periodic-madness__/graphics/icons/modules/speed-module-6.png",
        icon_size = 64,
        subgroup = "pm-speed",
        category = "speed",
        tier = 5,
        order = "e",
        stack_size = 50,
        effect = {speed = 1.3, consumption = 1.6},
        beacon_tint =
        {
          primary = {r = 0.441, g = 0.514, b = 1.000, a = 1.000}, -- #70b6ffff
          secondary = {r = 0.388, g = 0.766, b = 1.000, a = 1.000}, -- #63f8ffff
          ...
          layers =
            {
              {
                size = 64,
                filename = "__periodic-madness__/graphics/icons/modules/speed-module-6.png",
                scale = 0.5
              },
              {
                draw_as_light = true,
                flags = {"light"},
                size = 64,
                filename = "__periodic-madness__/graphics/light/speed-module-6-light.png",
                scale = 0.5
              }
            }
          },
      },
      {
        ...
        localised_description = {"item-description.effectivity-module"},
        icon = "__periodic-madness__/graphics/icons/modules/efficiency-module-6.png",
        icon_size = 64,
        subgroup = "pm-efficiency",
        category = "efficiency",
        tier = 5,
        order = "e",
        stack_size = 50,
        effect = { consumption = -0.9, speed = 0.45},
        beacon_tint =
        {
          primary = { 0, 1, 0 },
          secondary = {r = 0.370, g = 1.000, b = 0.370, a = 1.000}, -- #5eff5eff
          ...
          layers =
            {
              {
                size = 64,
                filename = "__periodic-madness__/graphics/icons/modules/efficiency-module-6.png",
                scale = 0.5
              },
              {
                draw_as_light = true,
                flags = {"light"},
                size = 64,
                filename = "__periodic-madness__/graphics/light/efficiency-module-6-light.png",
                scale = 0.5
              }
            }
          },
      },
      {
        ...
        localised_description = {"item-description.productivity-module"},
        icon = "__periodic-madness__/graphics/icons/modules/productivity-module-6.png",
        icon_size = 64,
        subgroup = "pm-productivity",
        category = "productivity",
        tier = 5,
          ...
          layers =
            {
              {
                size = 64,
                filename = "__periodic-madness__/graphics/icons/modules/productivity-module-6.png",
                scale = 0.5
              },
              {
                draw_as_light = true,
                flags = {"light"},
                size = 64,
                filename = "__periodic-madness__/graphics/light/productivity-module-6-light.png",
                scale = 0.5
              }
            }
          },
...

    {
      ...
      icon_size = 64,
      icon = "__periodic-madness__/graphics/icons/modules/copper-heat-pump.png",
      tier = 1,
      category = "pm-heat-pumps",
      subgroup = "pm-heat-pumps",
      order = "a",
      stack_size = 40,
      inventory_move_sound = item_sounds.metal_small_inventory_move,
      pick_sound = item_sounds.metal_small_inventory_pickup,
    ...
    }, --basic heat-pump
    {
      ...
      icon_size = 64,
      icon = "__periodic-madness__/graphics/icons/modules/aluminium-heat-pump.png",
      tier = 1,
      category = "pm-heat-pumps",
      subgroup = "pm-heat-pumps",
      order = "b",
    ...
    }, --worse copper, but better speed/consumption ratio
    {
      ...
      icon_size = 64,
      icon = "__periodic-madness__/graphics/icons/modules/tungsten-heat-pump.png",
      tier = 1,
      category = "pm-heat-pumps",
      subgroup = "pm-heat-pumps",
      order = "c",
    ...
    }, -- high heat capacity, less pollution
    {
      ...
      icon_size = 64,
      icon = "__periodic-madness__/graphics/icons/modules/molybdenum-heat-pump.png",
      tier = 1,
      category = "pm-heat-pumps",
      subgroup = "pm-heat-pumps",
      order = "d",
    ...
    }, --lowest consumption, -prod for balance
    {
      ...
      icon_size = 64,
      icon = "__periodic-madness__/graphics/icons/modules/gold-heat-pump.png",
      tier = 1,
      category = "pm-heat-pumps",
      subgroup = "pm-heat-pumps",
      order = "e",
    ...
    }, --efficiency module for heat pumps
    {
      ...
      icon_size = 64,
      icon = "__periodic-madness__/graphics/icons/modules/inconel-625-heat-pump.png",
      tier = 1,
      category = "pm-heat-pumps",
      subgroup = "pm-heat-pumps",
      order = "f",
