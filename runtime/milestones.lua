		...
		return {
			["Periodic Madness"] = {
				...
				milestones = 
				{
				   ...
				   {type = "item",  name = "pm-reactive-non-metal-science-pack", quantity = 1000, next = "x10"},
				   ...
				   {type = "item", name = "pm-transition-metals-ore", quantity = 10, next = "x20"},
				   ...
				   {type = "item", name = "pm-atmospheric-condenser", quantity = 1},
				   {type = "item", name = "pm-crystallizer", quantity = 1},
				   {type = "item", name = "pm-post-transition-metals-ore", quantity = 10, next = "x20"},
				   {type = "item", name = "pm-alkali-metals-ore", quantity = 10, next = "x20"},
				   ...
				   {type = "item", name = "pm-molten-inator", quantity = 1},
				   {type = "item", name = "pm-cold-inator", quantity = 1},
				   ...
				   {type = "fluid", name = "pm-phosgene", quantity = 4, next = "x10"},
