	...
	return {
		["Periodic Madness"] = {
			...
			milestones =
			{
				...
				{type = "item",  name = "pm-alkaline-earth-metal-science-pack", quantity = 1},
				{type = "item",  name = "automation-science-pack", quantity = 10000},
				{type = "item",  name = "logistic-science-pack", quantity = 10000},
				{type = "item",  name = "pm-advanced-advanced-transition-metal-science-pack", quantity = 10000},
				{type = "item",  name = "chemical-science-pack", quantity = 10000},
				{type = "item",  name = "pm-post-transition-metal-science-pack", quantity = 10000},
				{type = "item",  name = "pm-alkali-metal-science-pack", quantity = 10000},
				{type = "item",  name = "pm-metalloid-science-pack", quantity = 10000},
				{type = "item",  name = "pm-alkaline-earth-metal-science-pack", quantity = 10000},

				{type = "group", name = "Progresss"},
				{type = "fluid", name = "pm-hydrochloric-acid", quantity = 1},
				{type = "item", name = "pm-transition-metals-ore", quantity = 10, next = "x100"},
				{type = "fluid", name = "pm-acidic-water", quantity = 1},
				{type = "item", name = "pm-fluid-circuit", quantity = 1},
				...
				{type = "item", name = "pm-post-transition-metals-ore", quantity = 10, next = "x100"},
				...
				{type = "item", name = "pm-alkaline-earth-metals-ore", quantity = 10, next = "x20"},
				{type = "item", name = "pm-spiderling-issy", quantity = 1},
				...
				{type = "item", name = "pm-molten-inator-3", quantity = 1},
				{type = "item", name = "pm-cold-inator-3", quantity = 1},
