...
data:extend({

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/ferrum-decomposition.png",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/patina-decomposition.png",
    subgroup = "pm-advanced-ore-decomposition",
    category = "pm-acids",
    enabled = false,
    hide_from_player_crafting = true,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/ore-slag-transition-decomposition.png",
    subgroup = "pm-tm-tm",
    order = "c",
    enabled = false,
    energy_required = 2,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/ore-slag-chunk-decomposition.png",
    subgroup = "pm-tm-tm",
    order = "d",
    enabled = false,
    energy_required = 2,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/glass-resmelting.png",
    energy_required = 2,
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/mixed-ore-slag-crushing.png",
    enabled = false,
    energy_required = 9,
    category = "pm-crushing",
    subgroup = "pm-ptm-ptm",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/mixed-ore-slag-leeching.png",
    enabled = false,
    energy_required = 4.5,
    category = "pm-acids",
    subgroup = "pm-ptm-ptm",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/chromic-ferrum-decomposition.png",
    subgroup = "pm-advanced-ore-decomposition",
    order = "d",
    category = "pm-acids",
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/chromic-patina-decomposition.png",
    subgroup = "pm-advanced-ore-decomposition",
    order = "e",
    category = "pm-acids",
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/cobaltite-seperation.png",
    category = "pm-crushing",
    enabled = false,
    energy_required = 4,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/ferrous-waste-water-seperation.png",
    category = "chemistry",
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/cupric-waste-water-seperation.png",
    category = "chemistry",
    enabled = false,
    allow_productivity = true,
    energy_required = 15,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/ferrous-waste-water-looping.png",
    category = "pm-mixing",
    enabled = false,
    energy_required = 5,
    ingredients = 
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/cupric-waste-water-looping.png",
    category = "pm-mixing",
    enabled = false,
    energy_required = 5,
    ingredients = 
