...
data:extend({
...

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/trace-gas-condensation.png",
    category = "pm-atmospheric-condensing",
    subgroup = "pm-trace-gas-rnm",
    order = "c",
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/trace-gas-refining.png",
    energy_required = 3,
    enabled = false,
    category = "pm-atmospheric-condensing",
    subgroup = "pm-trace-gas-rnm",
...

  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/trace-gas-voiding.png",
    category = "pm-atmospheric-condensing",
    subgroup = "pm-trace-gas-rnm",
    order = "d",
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/dirty-air-filter-washing.png",
    energy_required = 4,
    enabled = false,
    category = "pm-washing",
  ...
  },
  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/lithium-dirty-air-filter-cleaning.png",
    energy_required = 4,
    enabled = false,
    category = "pm-washing",
    subgroup = "pm-air-filters-rnm",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/sodium-dirty-air-filter-1-cleaning.png",
    energy_required = 4,
    enabled = false,
    category = "pm-washing",
    subgroup = "pm-air-filters-rnm",
  ...
  },
  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/sodium-dirty-air-filter-cleaning.png",
    energy_required = 2,
    enabled = false,
    category = "pm-washing",
    subgroup = "pm-air-filters-rnm",
