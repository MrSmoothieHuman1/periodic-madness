...
data:extend({

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/water-electroylsis.png",
...

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/salt-electroylsis.png",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/gas-water-electroylsis.png",
    energy_required = 1,
    enabled = false,
    category = "pm-electrolysis",
    subgroup = "pm-hydrogen-rnm",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/zirconia-CO2-electroylsis.png",
    energy_required = 4,
    enabled = false,
    category = "pm-electrolysis",
