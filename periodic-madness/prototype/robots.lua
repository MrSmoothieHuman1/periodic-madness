...
robot_animations.logistic_robot =
{
  idle =
  {
    filename = "__periodic-graphics-1__/graphics/entities/buildings/lithium-logistic-robots/logistic-robot.png",
    priority = "high",
    line_length = 16,
    width = 80,
    height = 84,
  ...
  shadow_idle =
  {
    filename = "__periodic-graphics-1__/graphics/entities/buildings/lithium-logistic-robots/logistic-robot-shadow.png",
    priority = "high",
    line_length = 16,
    width = 115,
    height = 57,
...
robot_animations.construction_robot =
{
  idle =
  {
    filename = "__periodic-graphics-1__/graphics/entities/buildings/lithium-construction-robots/construction-robot.png",
    priority = "high",
    line_length = 16,
    width = 66,
    height = 76,
  ...
  {
    filename =
    "__periodic-graphics-1__/graphics/entities/buildings/lithium-construction-robots/construction-robot-shadow.png",
    priority = "high",
    line_length = 16,
    width = 104,
    height = 49,
  ...
  {
    filename =
    "__periodic-graphics-1__/graphics/entities/buildings/lithium-construction-robots/construction-robot-working.png",
    priority = "high",
    line_length = 2,
    width = 57,
    height = 74,
