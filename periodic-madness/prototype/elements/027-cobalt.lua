...
data:extend({

  {
    ...
    name = "pm-cobalt-blue",
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/cobalt-blue.png",
  ...
  },
  {
    ...
    name = "pm-cobaltite",
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/ores/cobaltite.png",
    pictures =
    {
      { filename = "__pm-graphics-01__/graphics/icons/ores/cobaltite.png",   size = 64, scale = 0.5 },
      { filename = "__pm-graphics-01__/graphics/icons/ores/cobaltite-2.png", size = 64, scale = 0.5 },
      { filename = "__pm-graphics-01__/graphics/icons/ores/cobaltite-3.png", size = 64, scale = 0.5 },
    },
    subgroup = "pm-cobalt-tm",
    order = "b",
    stack_size = 400
...

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/copper-chunk-frothing.png",
    category = "pm-washing",
    subgroup = "pm-cobalt-tm",
    order = "a",
    enabled = false,
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/copper-froth-seperation.png",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/cobalt-blue-seperation.png",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/copper-tailings-looping.png",
    category = "pm-mixing",
    subgroup = "pm-cobalt-tm",
    order = "ca",
    enabled = false,
...

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/fluxed-copper-froth-seperation.png",
    category = "pm-moltening",
    subgroup = "pm-cobalt-tm",
    order = "ba",
    enabled = false,
