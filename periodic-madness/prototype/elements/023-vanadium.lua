...
data:extend({

  {
    ...
    name = "pm-magnetite",
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/ores/magnetite.png",
    pictures =
    {
      { filename = "__pm-graphics-01__/graphics/icons/ores/magnetite.png",   size = 128, scale = 0.124 + 0.01 },
      { filename = "__pm-graphics-01__/graphics/icons/ores/magnetite-2.png", size = 128, scale = 0.126 },
      { filename = "__pm-graphics-01__/graphics/icons/ores/magnetite-3.png", size = 128, scale = 0.124 },
    },
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/ores/ferrovanadium.png",
    pictures =
    {
      {filename = "__pm-graphics-01__/graphics/icons/ores/ferrovanadium.png", size = 64, scale = 0.5},
      {filename = "__pm-graphics-01__/graphics/icons/ores/ferrovanadium-2.png", size = 64, scale = 0.5},
    },
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/vanadate-solution-seperation.png",
    enabled = false,
    energy_required = 9,
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/iodine-vanadate-solution-seperation.png",
    enabled = false,
    energy_required = 9,
    category = "pm-coldening",
    subgroup = "pm-vanadium-tm",
