...
data:extend({
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/low-quality-crude-antimony-sulfide.png",
        pictures = 
        {
            {filename = "__pm-graphics-01__/graphics/icons/ores/low-quality-crude-antimony-sulfide.png", size = 64, scale = 0.5},
            {filename = "__pm-graphics-01__/graphics/icons/ores/low-quality-crude-antimony-sulfide-2.png", size = 64, scale = 0.5},
        },
    ...
    },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/high-quality-crude-antimony-sulfide.png",
        pictures = 
        {
            {filename = "__pm-graphics-01__/graphics/icons/ores/high-quality-crude-antimony-sulfide.png", size = 64, scale = 0.5},
            {filename = "__pm-graphics-01__/graphics/icons/ores/high-quality-crude-antimony-sulfide-2.png", size = 64, scale = 0.5},
        },
        subgroup = "pm-antimony-mt",
        order = "b",
        stack_size = 500
    },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/crude-antimony-sulfide.png",
        subgroup = "pm-antimony-mt",
        order = "c",
        stack_size = 250
    },
    {
        ...
        name = "pm-stibnite",
        icon_size = 128,
        icon = "__pm-graphics-01__/graphics/icons/ores/stibnite.png",
        pictures =
        {
            {filename = "__pm-graphics-01__/graphics/icons/ores/stibnite.png", size = 128, scale = 0.25},
            {filename = "__pm-graphics-01__/graphics/icons/ores/stibnite-2.png", size = 128, scale = 0.25},
            {filename = "__pm-graphics-01__/graphics/icons/ores/stibnite-3.png", size = 128, scale = 0.25},
            {filename = "__pm-graphics-01__/graphics/icons/ores/stibnite-4.png", size = 128, scale = 0.25},
        },
        subgroup = "pm-antimony-mt",
        order = "d",
        stack_size = 250
    },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/antimony-sulfide.png",
        subgroup = "pm-antimony-mt",
        order = "da",
        stack_size = 200
    },

    {
        ...
        name = "pm-crude-antimony-sulfide",
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/recipes/crude-antimony-seperation.png",
        enabled = false,
        energy_required = 4,
        category = "pm-acids",
        subgroup = "pm-antimony-mt",
