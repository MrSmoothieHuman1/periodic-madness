...
data:extend({
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/chlorine-condensation.png",
    category = "pm-atmospheric-condensing",
    subgroup = "pm-chlorine-rnm",
    order = "d",
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/chlorine-voiding.png",
    category = "pm-atmospheric-condensing",
    subgroup = "pm-chlorine-rnm",
    order = "e",
    enabled = false,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/seawater-refining.png",
    subgroup = "pm-chlorine-rnm",
    order = "f",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/HCl-neutralisation.png",
    energy_required = 1,
    enabled = false,
    category = "pm-washing",
    subgroup = "pm-chlorine-rnm",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/carbon-tetrachloride-seperation.png",
    enabled = false,
    category = "chemistry",
    subgroup = "pm-chlorine-rnm",
    order = "l",
