...
data:extend({

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/hydrogen-bromide-leeching.png",
    enabled = false,
    energy_required = 10,
    category = "pm-washing",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/hydrogen-bromide-seperation.png",
    enabled = false,
    energy_required = 5,
    ...
    results =
    {
      ...
      PM.catalyst_range_chance("pm-palladium-catalyst", 1, 2, 0.85, 2),
