...
data:extend({
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/ores/lithium-chloride.png",
    pictures =
    {
      { filename = "__pm-graphics-01__/graphics/icons/ores/lithium-chloride.png",   size = 64, scale = 0.5 },
      { filename = "__pm-graphics-01__/graphics/icons/ores/lithium-chloride-2.png", size = 64, scale = 0.5 },
    },
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/ores/lithium-bromide.png",
    pictures =
    {
      { filename = "__pm-graphics-01__/graphics/icons/ores/lithium-bromide.png",   size = 64, scale = 0.5 },
      { filename = "__pm-graphics-01__/graphics/icons/ores/lithium-bromide-2.png", size = 64, scale = 0.5 },
    },
    subgroup = "pm-lithium-am",
    order = "x",
    stack_size = 100
...

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/calcium-brine.png",
    energy_required = 3,
    category = "pm-washing",
    subgroup = "pm-lithium-am",
    order = "A",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/sodium-brine.png",
    energy_required = 4,
    category = "pm-washing",
    subgroup = "pm-lithium-am",
    order = "a",
