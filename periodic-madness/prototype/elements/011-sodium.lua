...
data:extend({

  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/sodium-bicarbonate.png",
  ...
  },
  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/sodium-carbonate.png",
    subgroup = "pm-sodium-am",
    order = "b",
    stack_size = 200
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/sodium-sulfite.png",
    pictures = 
    {
        {filename = "__pm-graphics-01__/graphics/icons/sodium-sulfite.png", size = 64, scale = 0.5},
        {filename = "__pm-graphics-01__/graphics/icons/sodium-sulfite-2.png", size = 64, scale = 0.5},
    },
    subgroup = "pm-sodium-am",
    order = "c",
    stack_size = 100
...

  {
    ...
    name = "pm-sodium-bicarbonate",
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/sodium-bicarbonate-mixing.png",
    enabled = false,
    category = "pm-washing",
    subgroup = "pm-sodium-am",
    order = "a",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/ammonium-chloride-seperation.png",
    enabled = false,
    category = "pm-acids",
    subgroup = "pm-sodium-am",
    order = "b",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/sodium-carbonate-seperation.png",
    enabled = false,
    category = "pm-moltening",
    subgroup = "pm-sodium-am",
    order = "d",
