...
data:extend({

  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/ores/platinum-powder.png",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/ammonium-chloride.png",
    pictures = 
    {
      {filename = "__pm-graphics-01__/graphics/icons/ammonium-chloride.png", size = 64, scale = 0.5 },
      {filename = "__pm-graphics-01__/graphics/icons/ammonium-chloride-2.png", size = 64, scale = 0.5 },
    },
    subgroup = "pm-platinum-tm",
    order = "x",
    stack_size = 100
...

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/nickel-chunk-frothing.png",
    category = "pm-washing",
    subgroup = "pm-platinum-tm",
    order = "a",
    enabled = false,
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/platinum-nickel-froth-seperation.png",
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/platinum-powder-seperation.png",
    category = "pm-acids",
    subgroup = "pm-platinum-tm",
    order = "d",
    enabled = false,
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/nickel-tailings-looping.png",
    category = "pm-mixing",
    subgroup = "pm-platinum-tm",
    order = "c",
    enabled = false,
...

  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/flux-platinum-nickel-froth-seperation.png",
    category = "pm-moltening",
    subgroup = "pm-platinum-tm",
    order = "ba",
    enabled = false,
