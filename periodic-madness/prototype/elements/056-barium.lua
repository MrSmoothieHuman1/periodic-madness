...
data:extend({
    ...
    },
    {
        ...
        name = "pm-pure-baryte",
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/pure-baryte.png",
        pictures =
        {
            {filename = "__pm-graphics-01__/graphics/icons/ores/pure-baryte.png",   size = 64, scale = 0.5},
            {filename = "__pm-graphics-01__/graphics/icons/ores/pure-baryte-2.png", size = 64, scale = 0.5},
            {filename = "__pm-graphics-01__/graphics/icons/ores/pure-baryte-3.png", size = 64, scale = 0.5},
        },
        subgroup = "pm-barium-aem",
        order = "c",
        stack_size = 200,
