...
data:extend({
    ...
    },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/recipes/carbon-dioxide-condensation.png",
        category = "pm-atmospheric-condensing",
        subgroup = "pm-carbon-rnm",
        order = "d",
        enabled = false,
    ...
    },
    {
        ...
        icon_size = 128,
        icon = "__pm-graphics-01__/graphics/icons/recipes/carbon-dioxide-voiding.png",
        category = "pm-atmospheric-condensing",
        subgroup = "pm-carbon-rnm",
        order = "e",
        enabled = false,
    ...
    },
    {
      ...
      icon_size = 128,
      icon = "__pm-graphics-01__/graphics/icons/recipes/carbon-monoxide-voiding.png",
      category = "pm-atmospheric-condensing",
      subgroup = "pm-carbon-rnm",
      order = "ea",
      enabled = false,
  ...
  },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/fluids/carbon-dioxide.png",
    ...
    },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/fluids/carbon-trioxide.png",
        category = "pm-CO2-nullifying",
        subgroup = "pm-carbon-rnm",
        order = "g",
        enabled = false,
