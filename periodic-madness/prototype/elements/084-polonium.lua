...
data:extend({

  {
    ...
    name = "pm-bismuth-210",
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/ores/bismuth-210-icon.png",
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/ores/polonium-ore-icon.png",
    pictures =
    {
      { filename = "__pm-graphics-01__/graphics/icons/ores/polonium-ore-icon.png",   size = 64, scale = 0.5 },
      { filename = "__pm-graphics-01__/graphics/icons/ores/polonium-ore-icon-2.png", size = 64, scale = 0.5 },
    },
    subgroup = "pm-polonium-ptm",
    order = "b",
    stack_size = 200
  ...
  } --[[@as data.RecipePrototype]],
  {
    ...
    name = "pm-polonium-210",
    icon_size = 128,
    icon = "__pm-graphics-01__/graphics/icons/recipes/bismuth-210-decay.png",
    enabled = false,
    energy_required = 45,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/polonium-fuel-reprocessing.png",
    enabled = false,
    energy_required = 30,
  ...
  },
  {
    ...
    icon_size = 64,
    icon = "__pm-graphics-01__/graphics/icons/recipes/polonium-sassxolotl-enrichment.png",
