...
data:extend({

    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/mixed-astatine.png",
        pictures =
        {
          { filename = "__pm-graphics-01__/graphics/icons/ores/mixed-astatine.png", size = 64, scale = 0.5 },
          { filename = "__pm-graphics-01__/graphics/icons/ores/mixed-astatine-2.png", size = 64, scale = 0.5 },
        },
      ...
      },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-209.png",
        pictures =
        {
          { filename = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-209.png", size = 64, scale = 0.5 },
          { filename = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-209-2.png", size = 64, scale = 0.5 },
        },
        subgroup = "pm-astatine-ptm",
        order = "b",
        stack_size = 100
      },
      {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-210.png",
        pictures =
        {
          { filename = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-210.png", size = 64, scale = 0.5 },
          { filename = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-210-2.png", size = 64, scale = 0.5 },
        },
        subgroup = "pm-astatine-ptm",
        order = "c",
        stack_size = 150
      },
      {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-211.png",
        pictures =
        {
          { filename = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-211.png", size = 64, scale = 0.5 },
          --{ filename = "__pm-graphics-01__/graphics/icons/ores/trace-astatine-211-2.png", size = 64, scale = 0.5 },
        },
        subgroup = "pm-astatine-ptm",
        order = "d",
        stack_size = 200
    ...
    },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/recipes/mixed-astatine-seperation.png",
    ...
    },
    {
        ...
        icon_size = 64,
        icon = "__pm-graphics-01__/graphics/icons/recipes/trace-astatine-rearranging.png",
        category = "pm-cyclotroning",
        subgroup = "pm-astatine-ptm",
        order = "d",
        enabled = false,
