...
data:extend({
  ...
  },
  {
    type = "item",
    name = "pm-acid-plant",
    icon = "__pm-graphics-01__/graphics/icons/buildings/acid-plant.png",
    icon_size = 64,
...
data.raw["item"]["fast-transport-belt"].icon = "__pm-graphics-01__/graphics/icons/buildings/fast-transport-belt.png"
data.raw["item"]["fast-underground-belt"].icon = "__pm-graphics-01__/graphics/icons/buildings/fast-underground-belt.png"
data.raw["item"]["fast-splitter"].icon = "__pm-graphics-01__/graphics/icons/buildings/fast-splitter.png"
